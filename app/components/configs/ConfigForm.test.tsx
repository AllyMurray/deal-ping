...
describe("ConfigForm", () => {
  ...
  describe("duplicate search term detection", () => {
    // Note: Duplicate detection now uses useFetcher to submit to the route's action.
    // Full integration tests for duplicate detection should be done at the route level.
    // These tests verify the UI rendering behavior.
    ...
    it("does not show duplicate warning when editing existing config", () => {
      render(
        <ConfigForm
          {...defaultProps}
          isEditing={true}
